...
7. **Auditing performance of a model:** This function audits performance of the requested model and dataset version. (e.g model_name = "random forest_v1, dataset version = "v2")

```bash
curl -X GET "http://127.0.0.1:5000/audit_performance?model_name=random%20forest_v1&dataset_version=v2"
```
This will return the recall and precision of the model on the training set of the requested dataset. It will also output a graph of previous performances of the model in the terminal. For example:
```makefile
